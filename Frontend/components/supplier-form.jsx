...
export function SupplierForm() {
  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-muted-foreground">We've received your supplier registration and will contact you within 24 hours.</p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <Label htmlFor="supplier_contact_detail">Contact Details *</Label>
        <Input 
          id="supplier_contact_detail" 
          name="supplier_contact_detail" 
          value={formData.supplier_contact_detail}
          onChange={handleInputChange}
          required 
      ...
      <div>
        <Label htmlFor="products">Products You Supply *</Label>
        <Input 
          id="products" 
          name="products" 
