        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link
              ...
              className="group block bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-6 border border-gray-200"
            >
              <h2 className="text-xl font-semibold group-hover:text-primary transition-colors mb-2">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                The most common errors new exporters make — and how to avoid losing deals, time, and money.
              </p>
